...
export const WIKI: WikiEntry[] = [
  ...
  },
  {
    ...
    answer:
      ...
      '會員 15:00 報到（同時領票投票）、貴賓 16:30 報到；16:50 大師講座、17:30 中衛政策宣導、17:50 豐收晚宴、18:00 理事長就職典禮（21:00 賦歸）',
  ...
  },
  {
    ...
    answer:
      '當天議程 📋\n' +
      '15:00 會員報到（同時領選票及投票）\n' +
      '15:30 會務報告與理監事改選（含修改組織章程・現場開票）\n' +
      '16:30 貴賓報到\n' +
      '16:50 大師講座：傳承與創新—以科技驅動臺灣農產業韌性發展\n' +
      '17:30 政策宣導：中衛輔導計劃簡介\n' +
      '17:50 豐收晚宴\n' +
      '18:00 理事長就職典禮（席間舉行，21:00 賦歸）',
