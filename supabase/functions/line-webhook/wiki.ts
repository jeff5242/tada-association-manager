...
export const WIKI: WikiEntry[] = [
  ...
  },
  {
    ...
    answer:
      ...
      '會員 15:00 報到、貴賓 16:00 報到；16:10 大師講座、16:50 中衛政策宣導、17:30 理事長交接典禮、18:30 豐收晚宴（21:00 賦歸）',
  ...
  },
  {
    ...
    answer:
      ...
      '15:00 會員報到\n' +
      '15:10 會務報告・提案討論（含修改組織章程）\n' +
      '15:45 理監事暨理事長改選（有效會員領票投票）\n' +
      '16:00 貴賓報到\n' +
      '16:10 大師講座：AI 運用於農業的發展現況與展望\n' +
      '16:50 政策宣導：傳承與創新—以科技驅動臺灣農產業韌性發展（中衛）\n' +
      '17:05 Q&A・休息交流\n' +
      '17:30 理事長交接典禮\n' +
      '18:30 豐收晚宴（21:00 賦歸）',
  ...
  },
  {
    ...
    question: '講師是誰',
    answer:
      '大師講座講題：AI 運用於農業的發展現況與展望 🎓\n' +
      '講者：農業部農業試驗所 所長 李紅曦\n' +
      '時間：16:10 起。',
    keywords: ['講師', '演講', '講座', '誰來講', '大師', '主講', '講題', '李紅曦', '農試所'],
  ...
  },
  {
    ...
    answer:
      '會費說明 💰（3年會費一次繳清）\n' +
      '個人會員：入會費 NT$1,000 ＋ 3年會費 NT$6,000 ＝ 共 NT$7,000\n' +
      '團體會員：入會費 NT$10,000 ＋ 3年會費 NT$20,000 ＝ 共 NT$30,000',
