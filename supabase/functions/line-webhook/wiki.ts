...
export const WIKI: WikiEntry[] = [
  ...
  },
  {
    ...
    answer:
      ...
      '15:00 開放入場、15:30 會務討論、17:00 大師講座、17:40 交接典禮、18:00 豐收晚宴（20:30 賦歸）',
  ...
  },
  {
    ...
    answer:
      ...
      '16:30 政府補助計畫說明（中衛發展中心）\n' +
      '17:00 大師講座（40 分鐘）｜農業科技研究院 代理院長 李紅曦\n' +
      '17:40 理事長交接典禮\n' +
      '18:00 豐收晚宴（20:30 賦歸）',
  ...
  },
  {
    ...
    question: '講師是誰',
    answer:
      '大師講座講師：財團法人農業科技研究院 代理院長 李紅曦 🎓\n' +
      '時間：17:00 起，專題演講 40 分鐘（講題確認中）。',
    keywords: ['講師', '演講', '講座', '誰來講', '李紅曦', '大師', '主講', '農科院'],
